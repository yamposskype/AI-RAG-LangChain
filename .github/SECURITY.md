...
This document describes the security vulnerability disclosure process for the **RAG Chatbot System** project. It covers supported versions, reporting guidelines, response commitments, and safe-harbor protections for security researchers.
...
—you will not face legal action from the RAG Chatbot System team.
