...
(function() {
    ...
    document.querySelectorAll('a[target="_blank"]').forEach(link => {
        if (!link.querySelector('.external-icon')) {
            ...
            icon.style.cssText = 'margin-left: 0.25rem; font-size: 0.75em; opacity: 0.7;';
    ...
    window.addEventListener('load', () => {
        ...
        const visibleElements = document.querySelectorAll('.hero-content > *, .stats');
    ...
    // ========== Console Message ==========
    console.log('%c🤖 RAG AI System', 'font-size: 24px; font-weight: bold; color: #667eea;');
    console.log('%cWelcome to the Advanced RAG AI System!', 'font-size: 14px; color: #b8c1ec;');
    console.log('%cBuilt with React, Flask, LangChain, and Ollama', 'font-size: 12px; color: #8892b8;');
    console.log('%cGitHub: https://github.com/hoangsonww/RAG-AI-System-Portfolio-Support', 'font-size: 12px; color: #4facfe;');
    
    // Debug scroll features
    console.log('%c✅ Scroll Progress Bar:', scrollProgressBar ? 'Initialized' : '❌ Not found', 'color: #4caf50');
    console.log('%c✅ Navigation Links:', navLinks.length > 0 ? `Found ${navLinks.length} links` : '❌ Not found', 'color: #4caf50');
    console.log('%c✅ Sections:', sections.length > 0 ? `Found ${sections.length} sections` : '❌ Not found', 'color: #4caf50');
    
    // Debug mobile menu
    console.log('%c✅ Mobile Menu Toggle:', mobileMenuToggle ? 'Found' : '❌ Not found', 'color: #4caf50');
    console.log('%c✅ Nav Menu:', navMenu ? 'Found' : '❌ Not found', 'color: #4caf50');
    ...
    function init() {
        ...
        const animatedElements = document.querySelectorAll('.hero-content > *, .stats');
